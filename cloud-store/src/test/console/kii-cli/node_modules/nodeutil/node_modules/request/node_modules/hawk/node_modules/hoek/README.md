...
target.a(funName(err, result){console.log(result)}         // returns 'a!'       

target.c(funName(err, result){console.log(result)}         // returns undefined

target.b(funName(err, result){console.log(result)}         // gives error: Object [object Object] has no method 'b'
