...
INSERT INTO `permission` (`source_id`, `name`, `action`) VALUES ('1', 'BindTagToUserGroup', 'POST /tags/*/userGroup/*');
INSERT INTO `permission` (`source_id`, `name`, `action`) VALUES ('1', 'RemoveTagFromUserGroup', 'DELETE /tags/*/userGroup/*');
