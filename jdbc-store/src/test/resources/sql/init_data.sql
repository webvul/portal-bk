...
INSERT INTO `permission` (`source_id`, `name`, `action`) VALUES ('2', 'BindThingTag', 'PUT /things/*/tags/*');
...
INSERT INTO `permission` (`source_id`, `name`, `action`) VALUES ('3', 'RemoveUserToGroup', 'PUT /usergroup/*/user/*');
...
INSERT INTO `permission` (`source_id`, `name`, `action`) VALUES ('4', 'RemovePermissionToUserGroup', 'PUT /permission/*/userGroup/*');
