...
@Repository
public class TeamGroupRelationDao extends SpringBaseDao<TeamGroupRelation> {
	...
	public TeamGroupRelation findByTagIDAndUserGroupID(Long teamID, Long userGroupID) {
		if(teamID!=null && userGroupID!=null){
