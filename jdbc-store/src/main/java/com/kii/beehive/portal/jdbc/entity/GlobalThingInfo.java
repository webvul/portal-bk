...
public class GlobalThingInfo extends BusinessEntity {
	...
	public  final static Pattern validVendorThingIDPattern = Pattern.compile("^\\[A-Z]{4}\\w-[A-Z][\\d]{2}-\\w{1}-\\d{3}$");
	
	
	public  final static Pattern locationPattern = Pattern.compile("^\\[A-Z]{4}\\w-[A-Z][\\d]{2}$");
