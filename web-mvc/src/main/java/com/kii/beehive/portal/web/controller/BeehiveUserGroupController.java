...
import com.kii.beehive.portal.manager.BeehiveUserGroupManager;
 ...
 */
@RestController
@RequestMapping(path = "/beehiveusergroup",  consumes = {MediaType.APPLICATION_JSON_UTF8_VALUE}, produces = {MediaType.APPLICATION_JSON_UTF8_VALUE})
public class BeehiveUserGroupController {

    @Autowired
    private BeehiveUserGroupManager userGroupManager;
